...
namespace Autohand.Demo{
    public class inventoryeventscript : MonoBehaviour{
        public Hand hand;
        public Camera head;
        ...
        bool showing = false;
        Vector3 armpos,armposR;

        private void Start() {
            
            
            armpos = head.transform.position+ new Vector3(.2f,0,0);
        ...
        void Update(){
            ...
            float distance = Vector3.Distance(armpos, hand.palmTransform.position);
            bool found = distance < maxDistance ;//&& hand.holdingObj == null;
